...
impl Game{
    ...
    pub fn update(&mut self,egpu: &mut easy_gpu::Renderer, file_manager: &mut FileManager,input_manager: &InputManager){
        ...
        self.chunk_manager.load_chunks_data(file_manager,&mut self.terrain_generator);
        ...
        self.update_player(input_manager);
    }

    fn update_player(&mut self,input_manager: &InputManager) {
